...
const (
	FinalizerString = "finalizers.route53.services.k8s.aws/ReusableDelegationSet"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("reusabledelegationsets")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ReusableDelegationSet{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ReusableDelegationSet),
	}
}
