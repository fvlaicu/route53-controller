...
// +kubebuilder:rbac:groups=route53.services.k8s.aws,resources=reusabledelegationsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53.services.k8s.aws,resources=reusabledelegationsets/status,verbs=get;update;patch
